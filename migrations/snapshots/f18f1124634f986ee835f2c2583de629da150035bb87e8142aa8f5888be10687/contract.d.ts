...
export type StorageHash =
  StorageHashBase<'f18f1124634f986ee835f2c2583de629da150035bb87e8142aa8f5888be10687'>;
export type ExecutionHash =
  ExecutionHashBase<'564786bde25e0897f2dac521a06f0e6b1af10ce42d80b6a6debf69e474f11ca1'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly PacienteAtendimento: {
      ...
      readonly observacoes: CodecTypes['pg/text@1']['output'] | null;
      readonly evolucao: CodecTypes['pg/text@1']['output'] | null;
      ...
      readonly ativo: CodecTypes['pg/bool@1']['output'];
      readonly pacienteId: CodecTypes['pg/int4@1']['output'];
      readonly atendimentoOrigemId: CodecTypes['pg/int4@1']['output'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    ...
    readonly PacientePatologia: {
      ...
      readonly status: 'SUSPEITA' | 'CONFIRMADA' | 'RESOLVIDA' | 'SEM_PROBLEMA_CLINICO';
      readonly observacoes: CodecTypes['pg/text@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly PacienteAtendimento: {
      ...
      readonly observacoes: CodecTypes['pg/text@1']['input'] | null;
      readonly evolucao: CodecTypes['pg/text@1']['input'] | null;
      ...
      readonly ativo: CodecTypes['pg/bool@1']['input'];
      readonly pacienteId: CodecTypes['pg/int4@1']['input'];
      readonly atendimentoOrigemId: CodecTypes['pg/int4@1']['input'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly PacienteExame: {
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly pacienteAtendimento: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'pacienteAtendimento_atendimentoOrigemId_idx_b3773bde';
                  readonly prefix: 'pacienteAtendimento_atendimentoOrigemId_idx';
                  readonly columns: readonly ['atendimentoOrigemId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
          ...
          readonly valueSet: {
            ...
            readonly TipoAtendimento: {
              readonly kind: 'valueSet';
              readonly values: readonly ['CONSULTA', 'RETORNO'];
            };
            readonly TipoPerfil: {
              readonly kind: 'valueSet';
      ...
      readonly public: {
          ...
          readonly PacienteAtendimento: {
            ...
            readonly relations: {
              readonly atendimentoOrigem: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['atendimentoOrigemId'];
                  readonly targetFields: readonly ['id'];
                };
              };
              readonly exames: {
              ...
              readonly retornos: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['atendimentoOrigemId'];
                };
              };
            };
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly observacoes: { readonly column: 'observacoes' };
                readonly evolucao: { readonly column: 'evolucao' };
                ...
                readonly ativo: { readonly column: 'ativo' };
                readonly pacienteId: { readonly column: 'pacienteId' };
                readonly atendimentoOrigemId: { readonly column: 'atendimentoOrigemId' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
        ...
        readonly enum: {
          ...
          readonly TipoAtendimento: {
            readonly codecId: 'pg/text@1';
            readonly members: readonly [
              { readonly name: 'CONSULTA'; readonly value: 'CONSULTA' },
